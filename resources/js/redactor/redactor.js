...
var RLANG = {
	...
	drop_file_here: 'Бросьте файл здесь',
...
var Redactor = function(element, options)
{
	...
	this.opts = $.extend({
		...
		modal_image_edit: String() + 
			...
			'<div id="redactor_modal_footer">' +
				...
				'<span class="redactor_btns_box">' +
					'<input type="button" name="save" class=\'button smart huge\' id="redactorSaveBtn" value="' + RLANG.save + '" />' +
		...
		modal_image: String() + 
			...
			'<form id="redactorInsertImageForm" method="post" action="" enctype="multipart/form-data">' +
				'<div id="redactor_tab1" class="redactor_tab">' +
					'<input type="file" class=\'button smart huge\' id="redactor_file" name="file" />' +
				'</div>' +
			...
			'<div id="redactor_modal_footer">' +
				'<span class="redactor_btns_box">' +
					'<input type="button" class=\'button smart huge\' name="upload" id="redactor_upload_btn" value="' + RLANG.insert + '" />' +
					'<a href="javascript:void(null);" id="redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
				'</span>' +
			'</div>',
		...
		modal_link: String() + 
			...
			'<div id="redactor_modal_footer">' +
				'<span class="redactor_btns_box">' +
					'<input type="button" class=\'button smart huge\' id="redactor_insert_link_btn" value="' + RLANG.insert + '" />' +
					'<a href="javascript:void(null);" id="redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
				'</span>' +
			'</div>',
		...
		modal_table: String() + 
				...
				'<div id="redactor_modal_footer">' +
					'<span class="redactor_btns_box">' +
						'<input type="button" class=\'button smart huge\' name="upload" id="redactor_insert_table_btn" value="' + RLANG.insert + '" />' +
						'<a href="javascript:void(null);" id="redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
					'</span>' +
				'</div>',
		...
		modal_video: String() + 
			...
			'<div id="redactor_modal_footer">' +
				'<span class="redactor_btns_box">' +
					'<input type="button" class=\'button smart huge\' id="redactor_insert_video_btn" value="' + RLANG.insert + '" />' +
					'<a href="javascript:void(null);" id="redactor_btn_modal_close">' + RLANG.cancel + '</a>' +
				'</span>' +
			'</div>',
