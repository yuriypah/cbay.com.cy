...
return ( array ) json_decode ( file_get_contents ( "application/i18n/data/ru.json" ), true );
return array(
    'button' => array(
        'edit' => 'Редактировать',
        'buy_prestig' => 'Престиж',
    ...
    'package' => array(
        ...
        'description' => array(
            'premium' => 'Престиж объявление</span> - Престиж-объявление в течение 7 дней показывается на самом заметном месте сайта — в верхней части страниц результатов поиска и выделяется оранжевым цветом.<br> 3.99 euro',
            'vip' => 'VIP - объявления в течение 7 дней показываются в специальном VIP-блоке на страницах результатов поиска. <br> 2.99 euro',
            'selected' => 'Выделить объявление  - Выделенное объявление в течение 7 дней показывается на странице результатов поиска на специальном оранжевом фоне. При этом оно поднимется в результатах поиска бесплатно.<br> 1.99 euro',
            'top' => 'Поднять в поиске - Поднятое объявление поднимается на первое место в результатах поиска, и остается там в течение суток. <br> 0.99 euro',
            'free' => 'FREE - Бесплатное размещения обьявление на 30 дней'
        ),
        'pay' => array(
    ...
    'messages' => array(
        'generatesitemap' => 'Файл sitemap.xml создан',
        'site' => array(
            'sendfriend' => '',
            'message' => ''
        ),
    ...
    'index_page' => array(
        'text' => array(
            'title' => 'САЙТ БЕСПЛАТНЫХ ОБЪЯВЛЕНИЙ КИПРА - Cbay.com.cy',
...
чтобы помочь Вам быстрее продать Ваш товар.',
            'ads_counter' => array('объявление на сайте', 'объявления на сайте', 'объявлений на сайте'),
            ...
            'keywords' => 'cbay.com.cy, обьявления, Кипр'
        ),
    ),
    'search' => array(
        'label' => array(
    ...
    'adverts_page' => array(
        'empty' => array(
            ...
            'what_is' => 'Попробуйте:',
            'checkstring' => 'Проверить строку запроса - возможно Вы опечатались при выводе',
            'anotherwords' => 'Использовать другие ключевые слова в строке запроса',
            'anothertown' => 'Поискать интересующие Вас объявления в другом городе',
            'anotheradverse' => 'Посмотреть другие объявления в другом городе'
        ),
        'filter' => array(
            'all' => 'Все',
            'private' => 'Частные',
        ...
        'label' => array(
            'vip_header' => 'VIP - Обьявления'
        ),
        'seo' => array(
            'description' => 'объявления о продаже: category'
        )
    ),
    'advert' => array(
        'tooltip' => array(
...
(если ставим галочку в этом поле, напротив телефона загорается слово обязательно)',
            ...
            'keywords' => 'Укажите ключевые слова через запятую, как можно точнее описывающие Ваше обьявление',
            'amount' => 'ЭТО ПОЛЕ ОБЯЗАТЕЛЬНО ДЛЯ ЗАПОЛНЕНИЯ! <br />Устанавливайте разумную и не завышенную цену, посмотрите  сколько стоят аналогичные товары. Недорогие товары продаются гораздо быстрее.',
    ...
    'advert_page' => array(
        'label' => array(
            ...
            'price' => 'Цена',
            'shows' => 'Просмотров',
            'start_date' => 'Дата размещения',
            'finish_date' => 'Срок хранения – до',
    ...
    'place' => array(
        ...
        'error' => array(
            'no_category' => 'Не выбрана категория обьявления'
        )
    ),
    'backend' => array(
        'adverts' => array(
            'enabled' => 'Одобренные',
            'mark_enabled' => 'Отметить как одобренное',
            'new' => 'Новые',
    ...
    'profile_page' => array(
        ...
        'ended' => array(
            'title' => 'Нет ни одного завершенного обьявления',
            'what_is' => 'На этой странице отображаются обьявления у которых закончилось время публикации. Вы можете продлить публикацию обьявлений.'
        ),
        'blocked' => array(
            'title' => 'Нет ни одного Заблокированного обьявления',
            'what_is' => 'На этой странице отображаются заблокированные обьявления.'
        ),
        'settings' => array(
            'text' => array(
...
указанный Вами e-mail.'
    ...
    'layout' => array(
        'text' => array(
            'logo_text' => 'Самый большой сайт бесплатных объявлений Кипра',
    ...
    'menu' => array(
        'label' => array(
            ...
            'advert_confirm' => 'Подтверждение данных',
            ...
            'packages_pay' => 'Оплата пакета услуг'
        )
    ),
    'bookmarks' => array(
...
Не расстраивайтесь, выход есть!',
        'label' => array(
            ...
            'captcha' => 'Введен не верный код'
        )
    ),
    'captcha' => array(
        'label' => array(
            'title' => 'Защитный код',
            'lable' => 'Введите код с картинки'
        )
    ),
    'generatesitemap' => array(
        'label' => array(
            'create_button' => 'Создать sitemap.xml'
        )
    )
);