<div id="sub-sub-menu">
    <div class="wrapper">
        ...
        <div class="pull-right">
            ...
            <input type="button" onclick="backend.advAction('manyblock')" value=" <?= __('backend.adverts.block'); ?>" class="advert_deactivate btn btn-mini btn-warning">
        </div>
        <div class="clear"></div>
    </div>
</div>
        ...
        <div class="item  backend" data-id="63">
            ...
            <div class="content">
                ...
                <div class="options backend">
                    <span class=""><?= __('backend.adverts.author'); ?>: <?= HTML::anchor('backend/adverts/enabled/'.$advert->user_id.$ip, $advert->user, array('class' => '')); ?></span><br>
                    <span class="">IP: <?= HTML::anchor('backend/adverts/enabled/'.$id.'?ip='.$advert->ip(), $advert->ip(), array('class' => '')); ?></span><br>
            ...
            <div class="options backend">
                <a href="/backend/adverts/block/<?= $advert->id; ?>" class="advert_deactivate btn btn-mini btn-warning"><?= __('backend.adverts.block'); ?></a>
