...
<div id="paginator">
	<div class="navigation">
		<?php if ($previous_page !== FALSE): ?>
			<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" class="prev"><?php echo __('pagination.previous') ?></a>
		<?php else: ?>
			<span class="prev">	<?php echo __('pagination.previous') ?></span>
		<?php endif ?>
		...
		<?php if ($next_page !== FALSE): ?>
			<a href="<?php echo HTML::chars($page->url($next_page)) ?>" class="next"><?php echo __('pagination.next') ?></a>
		<?php else: ?>
			<span class="next">	<?php echo __('pagination.next') ?></span>
		<?php endif ?>
		<div class="clear"></div>
	</div>
