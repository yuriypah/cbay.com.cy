...
<hr/>
<?php
$userData = ORM::factory('user')->where('id', '=', Kohana_Auth::instance()->get_user()->id)->find();
$userProfile = '';
if ($userData->profile_id) {
    $userProfile = $userData->get_full_name($userData->profile_id);
    if ($userProfile)
...
<div class="control-group">
    ...
    <div class="controls">
        <?php
        echo Form::input('email', $userData->email, array(
            'id' => 'form-email'
        ));
        ?>
...
<div class="form-actions">
    <button name="action" value="message"
            class="btn btn-large"><?php echo __('advert.form.send') . ' ' . HTML::icon('chevron-right'); ?></button>
