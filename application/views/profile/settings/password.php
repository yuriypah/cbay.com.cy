...
<?php echo Form::hidden('token', Security::token()); ?>
    <div class="accordion_block">
        ...
        <div class="accordion" style="display:none">
            ...
            <div
                class="control-group <?php echo Arr::path($messages_array, 'errors.current_password') ? 'error' : ''; ?>">
                <label class="control-label"
                       for="profile_password_current"><?php echo __('profile_page.settings.label.current_password'); ?></label>
            ...
            <div class="control-group <?php echo Arr::path($messages_array, 'errors.password') ? 'error' : ''; ?>">
                <label class="control-label"
                       for="profile_password"><?php echo __('profile_page.settings.label.new_password'); ?></label>
            ...
            <div
                class="control-group <?php echo Arr::path($messages_array, 'errors.password_confirm') ? 'error' : ''; ?>">
                <label class="control-label"
                       for="profile_password_confirm"><?php echo __('profile_page.settings.label.confirm_password'); ?></label>
            ...
            <div class="control-group">
                <div class="controls">
                    <div class="row">
                        <div class="span2">
                            <button type="submit"
                                    class="btn"><?php echo __('profile_page.settings.label.change_password') . ' ' . HTML::icon('chevron-right'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
