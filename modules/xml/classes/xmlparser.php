 ...
 */
class XMLParser implements ArrayAccess, IteratorAggregate, Countable {
      /**
      ...
      public function appendChild($tag, $attributes) {
          $element = new XMLParser(array($tag, $attributes));
       ...
       * @var XML $parent
       */
      public function setParent(XMLParser $parent) {
          $this->parent =& $parent;
      }
